...
int main() {
    ...
    while ( ! feof(f) ) {
        fgets(choices, 4, f);
        if( ! strcmp(choices, "A X")) sum += 3;
        else if ( ! strcmp(choices, "A Y")) sum += 4;
        else if ( ! strcmp(choices, "A Z")) sum += 8;
        else if ( ! strcmp(choices, "B X")) sum += 1;
        else if ( ! strcmp(choices, "B Y")) sum += 5;
        else if ( ! strcmp(choices, "B Z")) sum += 9;
        else if ( ! strcmp(choices, "C X")) sum += 2;
        else if ( ! strcmp(choices, "C Y")) sum += 6;
        else if ( ! strcmp(choices, "C Z")) sum += 7;
    }
    fclose(f);
